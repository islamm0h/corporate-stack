...
export default function AssetsSystemDetails() {
  ...
  const systemFeatures = [
    'تسجيل وتصنيف الأصول والممتلكات',
    'تتبع حالة الأصول وجدولة الصيانة',
    'إدارة دورة حياة الأصول من الشراء للتخلص',
    'تقارير شاملة عن قيمة وأداء الأصول'
  ]
  ...
  const relatedSystems = [
    ...
    },
    {
      ...
      description: 'نظام متكامل لإدارة المشاريع وتتبع المهام والموارد والجداول الزمنية.',
      icon: 'fas fa-tasks'
    }
  ]
      ...
      <section className="system-header">
        <div className="container">
          <div className="system-header-content">
            <i className="fas fa-boxes system-details-icon"></i>
            <div>
              <h1 className="system-details-title">نظام إدارة الأصول</h1>
              <p className="system-details-description">
                نظام متكامل لإدارة الأصول والممتلكات وتتبع حالتها وصيانتها.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="system-features">
              ...
              <div style={{ marginTop: '40px' }}>
                ...
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)', marginBottom: '20px' }}>
                  نظام إدارة الأصول هو حل شامل ومتطور يساعد الشركات والمؤسسات على إدارة جميع أصولها وممتلكاتها بكفاءة عالية. يوفر النظام أدوات متقدمة لتسجيل وتصنيف الأصول وتتبع حالتها وقيمتها عبر دورة حياتها الكاملة.
                </p>
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)', marginBottom: '20px' }}>
                  يتميز النظام بواجهة سهلة الاستخدام تمكن إدارة الأصول من متابعة جميع الممتلكات من المعدات والآلات إلى المباني والمركبات. كما يوفر نظام صيانة متقدم يساعد في جدولة الصيانة الدورية والطارئة، مما يضمن الحفاظ على الأصول وإطالة عمرها الافتراضي.
                </p>
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)' }}>
                  يدعم النظام إدارة الاستهلاك والإهلاك المحاسبي للأصول، بالإضافة إلى إمكانية تتبع تكاليف الصيانة والتشغيل وتحليل العائد على الاستثمار لكل أصل، مما يساعد في اتخاذ قرارات مدروسة حول الاستثمار في الأصول الجديدة أو التخلص من الأصول القديمة.
                </p>
              </div>
              ...
              <div className="sidebar-card">
                ...
                <div className="related-systems">
                  {relatedSystems.map((system) => (
                    <Link key={system.id} href={system.id === 1 ? '/systems/accounting' : system.id === 5 ? '/systems/projects' : `/systems/${system.id}`} className="related-system">
