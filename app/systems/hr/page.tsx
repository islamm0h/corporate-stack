...
export default function HRSystemDetails() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/quote-requests', {
        ...
        body: JSON.stringify({
          ...formData,
          systemType: 'نظام إدارة الموارد البشرية',
      ...
      <section className="system-header">
        <div className="container">
          <div className="system-header-content">
            <i className="fas fa-user-tie system-details-icon"></i>
            <div>
              <h1 className="system-details-title">نظام إدارة الموارد البشرية</h1>
              <p className="system-details-description">
                نظام متكامل لإدارة شؤون الموظفين والرواتب والإجازات والتقييمات.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="system-features">
              ...
              <div style={{ marginTop: '40px' }}>
                ...
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)', marginBottom: '20px' }}>
                  نظام إدارة الموارد البشرية هو حل شامل ومتكامل يساعد الشركات والمؤسسات على إدارة جميع جوانب الموارد البشرية بكفاءة عالية. يوفر النظام أدوات متقدمة لإدارة بيانات الموظفين وتتبع أدائهم وإدارة الرواتب والمكافآت.
                </p>
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)', marginBottom: '20px' }}>
                  يتميز النظام بواجهة سهلة الاستخدام تمكن إدارة الموارد البشرية من متابعة جميع شؤون الموظفين من التوظيف حتى انتهاء الخدمة. كما يوفر تقارير تفصيلية عن الأداء والحضور والغياب والإجازات، مما يساعد في اتخاذ قرارات إدارية مدروسة.
                </p>
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)' }}>
                  يدعم النظام إدارة الهيكل التنظيمي للشركة وتحديد المسؤوليات والصلاحيات، بالإضافة إلى إمكانية إدارة برامج التدريب والتطوير المهني للموظفين وتقييم فعاليتها.
                </p>
              </div>
