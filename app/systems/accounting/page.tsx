...
export default function AccountingSystemDetails() {
  ...
  const systemFeatures = [
    'إصدار الفواتير الإلكترونية المتوافقة مع متطلبات هيئة الزكاة والضريبة',
    'إدارة الحسابات والميزانيات بكفاءة عالية',
    'تقارير مالية متقدمة وقابلة للتخصيص',
    'تكامل مع الأنظمة الأخرى مثل نظام إدارة المخزون ونظام نقاط البيع'
  ]
      ...
      <section className="system-header">
        <div className="container">
          <div className="system-header-content">
            <i className="fas fa-file-invoice-dollar system-details-icon"></i>
            <div>
              <h1 className="system-details-title">نظام الحسابات والفاتورة الإلكترونية</h1>
              <p className="system-details-description">
                نظام متكامل لإدارة الحسابات والفواتير الإلكترونية بكفاءة عالية وفقًا لمتطلبات هيئة الزكاة والضريبة والجمارك.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="system-features">
              ...
              <div style={{ marginTop: '40px' }}>
                ...
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)', marginBottom: '20px' }}>
                  نظام الحسابات والفاتورة الإلكترونية هو نظام متكامل يوفر حلولًا شاملة لإدارة الحسابات والفواتير الإلكترونية بكفاءة عالية وفقًا لمتطلبات هيئة الزكاة والضريبة والجمارك.
                </p>
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)', marginBottom: '20px' }}>
                  يتميز النظام بواجهة سهلة الاستخدام وتقارير متقدمة تساعد في اتخاذ القرارات المالية الصحيحة. كما يوفر النظام إمكانية إصدار الفواتير الإلكترونية وإرسالها مباشرة للعملاء وحفظها في قاعدة البيانات.
                </p>
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)' }}>
                  يدعم النظام جميع متطلبات الفوترة الإلكترونية في المملكة العربية السعودية، بما في ذلك ختم التشفير QR Code وتوثيق الفواتير إلكترونيًا.
                </p>
              </div>
              ...
              <div className="sidebar-card">
                ...
                <div className="related-systems">
                  {relatedSystems.map((system) => (
                    <Link key={system.id} href={system.id === 2 ? '/systems/crm' : system.id === 4 ? '/systems/assets' : `/systems/${system.id}`} className="related-system">
