...
export default function ProjectsSystemDetails() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/quote-requests', {
        ...
        body: JSON.stringify({
          ...formData,
          systemType: 'نظام إدارة المشاريع',
  ...
  const systemFeatures = [
    'تخطيط وإدارة المشاريع بكفاءة',
    'تتبع المهام والمراحل الزمنية',
    'إدارة الموارد والفرق العاملة',
    'تقارير تقدم المشاريع والأداء'
  ]
      ...
      <section className="system-header">
        <div className="container">
          <div className="system-header-content">
            <i className="fas fa-tasks system-details-icon"></i>
            <div>
              <h1 className="system-details-title">نظام إدارة المشاريع</h1>
              <p className="system-details-description">
                نظام متكامل لإدارة المشاريع وتتبع المهام والموارد والجداول الزمنية.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="system-features">
              ...
              <div style={{ marginTop: '40px' }}>
                ...
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)', marginBottom: '20px' }}>
                  نظام إدارة المشاريع هو حل شامل ومتطور يساعد الشركات والمؤسسات على إدارة مشاريعها بكفاءة عالية من البداية حتى النهاية. يوفر النظام أدوات متقدمة لتخطيط المشاريع وتحديد المهام وتوزيع الموارد وتتبع التقدم المحرز.
                </p>
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)', marginBottom: '20px' }}>
                  يتميز النظام بواجهة سهلة الاستخدام تمكن مديري المشاريع من متابعة جميع جوانب المشروع في مكان واحد. كما يوفر أدوات تعاون متقدمة تساعد فرق العمل على التواصل والتنسيق بفعالية، مع إمكانية تتبع الوقت والتكاليف وإدارة المخاطر.
                </p>
                <p style={{ lineHeight: '1.8', color: 'var(--gray-color)' }}>
                  يدعم النظام منهجيات إدارة المشاريع المختلفة مثل Agile وWaterfall، بالإضافة إلى إمكانية إنشاء تقارير تفصيلية عن أداء المشاريع والفرق، مما يساعد في تحسين الكفاءة واتخاذ قرارات مدروسة لضمان نجاح المشاريع في الوقت المحدد وضمن الميزانية المخصصة.
                </p>
              </div>
              ...
              <div className="sidebar-card">
                ...
                <div className="related-systems">
                  {relatedSystems.map((system) => (
                    <Link key={system.id} href={system.id === 3 ? '/systems/hr' : system.id === 4 ? '/systems/assets' : `/systems/${system.id}`} className="related-system">
